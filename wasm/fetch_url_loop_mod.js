...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'fetch_url_loop_mod.wast';
  var wasmBinaryFile = 'fetch_url_loop_mod.wasm';
  var asmjsCodeFile = 'fetch_url_loop_mod.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_fetch_bol_loop_cpp() } });
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "setTempRet0": setTempRet0, "getTempRet0": getTempRet0, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_ii": nullFunc_ii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_vi": nullFunc_vi, "___lock": ___lock, "___setErrNo": ___setErrNo, "___syscall140": ___syscall140, "___syscall146": ___syscall146, "___syscall54": ___syscall54, "___syscall6": ___syscall6, "___unlock": ___unlock, "__emscripten_fetch_cache_data": __emscripten_fetch_cache_data, "__emscripten_fetch_delete_cached_data": __emscripten_fetch_delete_cached_data, "__emscripten_fetch_load_cached_data": __emscripten_fetch_load_cached_data, "__emscripten_fetch_xhr": __emscripten_fetch_xhr, "__emscripten_get_fetch_work_queue": __emscripten_get_fetch_work_queue, "_abort": _abort, "_clock_gettime": _clock_gettime, "_emscripten_get_now": _emscripten_get_now, "_emscripten_get_now_is_monotonic": _emscripten_get_now_is_monotonic, "_emscripten_is_main_browser_thread": _emscripten_is_main_browser_thread, "_emscripten_is_main_runtime_thread": _emscripten_is_main_runtime_thread, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_start_fetch": _emscripten_start_fetch, "flush_NO_FILESYSTEM": flush_NO_FILESYSTEM, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
// EMSCRIPTEN_START_ASM
var asm =Module["asm"]// EMSCRIPTEN_END_ASM
(Module.asmGlobalArg, Module.asmLibraryArg, buffer);

var real___GLOBAL__sub_I_fetch_bol_loop_cpp = asm["__GLOBAL__sub_I_fetch_bol_loop_cpp"]; asm["__GLOBAL__sub_I_fetch_bol_loop_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_fetch_bol_loop_cpp.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_fetch_bol_loop_cpp = Module["__GLOBAL__sub_I_fetch_bol_loop_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_fetch_bol_loop_cpp"].apply(null, arguments) };
...
if (typeof exports === 'object' && typeof module === 'object')
    ...
    btn = document.getElementById("btn_fetchurl_wasm");
    btn.addEventListener("click", fetchUrlWasm);
    
    function fetchUrlWasm(){
      Module();
    }
